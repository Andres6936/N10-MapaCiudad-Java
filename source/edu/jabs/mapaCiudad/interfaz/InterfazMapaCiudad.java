...
import edu.jabs.mapaCiudad.mundo.Calle;
import edu.jabs.mapaCiudad.mundo.Carrera;
import edu.jabs.mapaCiudad.mundo.Casa;
import edu.jabs.mapaCiudad.mundo.Construccion;
import edu.jabs.mapaCiudad.mundo.Edificio;
import edu.jabs.mapaCiudad.mundo.Esquina1;
import edu.jabs.mapaCiudad.mundo.Esquina2;
import edu.jabs.mapaCiudad.mundo.Esquina3;
import edu.jabs.mapaCiudad.mundo.Esquina4;
import edu.jabs.mapaCiudad.mundo.EstacionBomberos;
import edu.jabs.mapaCiudad.mundo.EstacionPolicia;
import edu.jabs.mapaCiudad.mundo.FormatoInvalidoExcepcion;
import edu.jabs.mapaCiudad.mundo.Glorieta;
import edu.jabs.mapaCiudad.mundo.Hospital;
import edu.jabs.mapaCiudad.mundo.IConstruccion;
import edu.jabs.mapaCiudad.mundo.MapaCiudad;
...
public class InterfazMapaCiudad extends JFrame
{
	 ...
	 * 
	 * @return Retorna InterfazMapaCiudad.NINGUNA o InterfazMapaCiudad.SELECCIONAR o
	 *         InterfazMapaCiudad.BORRAR o InterfazMapaCiudad.CALLE o
	 *         InterfazMapaCiudad.CARRERA o InterfazMapaCiudad.GLORIETA o
	 *         InterfazMapaCiudad.CASA o InterfazMapaCiudad.EDIFICIO o
	 *         InterfazMapaCiudad.ESQUINA1 o InterfazMapaCiudad.ESQUINA2 o
	 *         InterfazMapaCiudad.ESQUINA3 o InterfazMapaCiudad.ESQUINA4 o
	 *         InterfazMapaCiudad.ESTACION_BOMBEROS o
	 *         InterfazMapaCiudad.ESTACION_POLICIA o InterfazMapaCiudad.HOSPITAL
	 */
	 ...
	 * Cada construcción debe saber si las coordenadas indicadas sirven para
	 * eliminarla o no. <br>
	 * <b>post: </b> Si había una construcción que se pudiera eliminar en esa
	 * posición entonces esta se elimina seleccionada.
	 * 
	 ...
	 * <b>post: </b> Si había una construcción seleccionada entonces esta se
	 * elimina.
	 */
	...
	/**
	 * Muestra la ventana de texto utilizada para modificar el texto de la
	 * construcción sobre la que se hizo doble click.
	 */
	...
	/**
	 * Cambia la construcción actualmente seleccionada por la que contiene el punto
	 * x,y
	 * 
	...
	/**
	 * Agrega una construcción del tipo seleccionado en el panel de botones. Los
	 * atributos de la construcción también se sacan del panel de botones. <br>
	...
	/**
	 * Salva el mapa en el archivo del que se había cargado o donde se había salvado
	 * la última vez. <br>
	 * Si se trata de un mapa nuevo y no se ha salvado entonces se pregunta el
	 * nombre del archivo donde se salvará. <br>
	...
	/**
	 * Salva el mapa en un archivo del cual se le pregunta el nombre al usuario.
	 * <br>
	...
	/**
	 * Este método solicita una confirmación para realizar una acción que haría que
	 * el trabajo se perdiera. <br>
	 ...
	 * Si se selecciona "Cancelar", el archivo no se salva pero se retorna false
	 * para que la acción no se realice.
	 * 
	 * @return Retorna true si la acción se debe realizar; retorna false en caso
	 *         contrario.
	 */
	private boolean pedirConfirmacion( )
	{
		...
		int respuesta = JOptionPane.showConfirmDialog( this, "Desea guardar el archivo actual antes de continuar?",
				"Salvar", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE );
