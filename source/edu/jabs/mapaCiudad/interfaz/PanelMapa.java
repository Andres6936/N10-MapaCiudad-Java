...
public class PanelMapa extends JPanel implements MouseListener, MouseMotionListener
{
	...
	/**
	 * Este es el método llamado por la máquina virtual cuando hay que repintar el
	 * panel <br>
	 * . super.paint( g ) no sabe pintar las figuras, así que hay que sobrecargar el
	 * método.
	 * 
	 * @param g Es la superficie del panel
	 */
	...
	/**
	 * Este método se llama cuando se hace click sobre la superficie del panel mapa.
	 * <br>
	 * Dependiendo de la opción seleccionada se debe agregar una figura al mapa o se
	 * debe seleccionar una de las figuras existentes. <br>
	 * Si la opción seleccionada es SELECCIONAR y se hace doble click sobre una
	 * figura se debe poder cambiar su texto.
	 * 
	...
	/**
	 * Este método se llama cuando se mueve el mouse sobre la superficie del panel
	 * mapa. <br>
