...
public class Esquina2 extends Carretera
{
	...
	public void pintar( Graphics2D g )
	{
		...
		g.drawLine( x + MARGEN_CONSTRUCCION / 2, y + alto - MARGEN_CONSTRUCCION / 2, x + MARGEN_CONSTRUCCION / 2,
				y + alto - 2 );
		g.drawLine( x - MARGEN_CONSTRUCCION / 2 + ancho - 2, y + 1 + MARGEN_CONSTRUCCION / 2,
				x - MARGEN_CONSTRUCCION / 2 + ancho - 2, y + alto - 2 );

		// Pintar los bordes de la esquina-Parte oeste-este
		g.drawLine( x + 1, y + MARGEN_CONSTRUCCION / 2, x + ancho - MARGEN_CONSTRUCCION / 2 - 2,
				y + MARGEN_CONSTRUCCION / 2 );
		g.drawLine( x + 1, y - MARGEN_CONSTRUCCION / 2 + alto - 2, x + MARGEN_CONSTRUCCION / 2,
