...
public abstract class Construccion implements IConstruccion
{
	...
	/**
	 * Inicializa los puntos de la construcción a partir de la línea que estaba en
	 * el archivo <br>
	 * <b>post: </b> x,y tienen nuevos valores
	 * 
	 * @param lineaPuntos La línea con la información de los dos puntos
	 * @throws FormatoInvalidoExcepcion Se lanza esta excepción si el formato de la
	 *             línea no es el esperado
	 */
	...
	/**
	 * Inicializa el color del fondo a partir de la información que estaba contenida
	 * en el archivo <br>
	 * <b>post: </b> colorFondo tiene nuevo color
	 * 
	 * @param lineaFondo La línea de texto que indica el color del fondo de la
	 *            construcción
	 * @throws FormatoInvalidoExcepcion Se lanza esta excepción si el formato de la
	 *             línea no es el esperado
	 */
	 ...
	 * 
	 * @param lineaFuente La línea de texto que describe la fuente usada en el texto
	 *            de la construcción
	 * @throws FormatoInvalidoExcepcion Se lanza esta excepción si el formato de la
	 *             línea no es el esperado
	 */
	 ...
	 * @return Retorna true si el punto está dentro de la construcción. Retorna
