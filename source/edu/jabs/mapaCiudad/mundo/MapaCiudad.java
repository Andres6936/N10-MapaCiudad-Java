...
public class MapaCiudad
{
	...
	/**
	 * Es una lista con las construcciones que componen el mapa, ordenadas en el
	 * orden en el que fueron agregadas. <br>
	 ...
	 * 
	 * @param nombreArchivo El archivo de donde se va a cargar el mapa - archivo !=
	 *            null
	 * @throws FormatoInvalidoExcepcion Se lanza esta excepción si el archivo tiene
	...
	/**
	 * Crea una construcción con los datos contenidos en un archivo y la adiciona a
	 * la lista respectiva
	 * 
	 * @param tipoConstruccion Es la cadena que identifica el tipo de construcción
	 *            que se debe construir
	 * @param br Es el stream de donde se pueden leer los datos para crear la
	 *            construcción - br!=null
	 * @throws FormatoInvalidoExcepcion Se lanza esta excepción si el archivo tiene
	 *             un formato incorrecto
	 * @throws IOException Se lanza esta excepción si hay problemas leyendo del
	 *             archivo
	 */
	private void crearConstruccion( String tipoConstruccion, BufferedReader br )
			throws FormatoInvalidoExcepcion, IOException
	{
		IConstruccion nueva;
	 ...
	 * @param colorFondo Color de fondo que se le quiere poner a la figura de la
	 *            cosntrucción.
	...
	/**
	 * Retorna el nombre del archivo donde se está guardando la información de este
	 * mapa
	 * 
	 * @return archivo. Si no se ha establecido todavía el nombre del archivo,
	 *         retorna null.
	 */
	 ...
	 * 
	 * @param g Es la superficie sobre la que deben quedar las construcciones - g !=
	 *            null y g es una superficie limpia (no se va a borrar antes de
	 *            pintar)
	 */
	...
	/**
	 * Elimina la construcción que contiene los puntos especificados. Si ninguna
	 * construcción contiene los puntos no se elimina nada
	 * 
	 ...
	 * @return Construcción que contiene los dos puntos especificados. Si ninguna
	 *         construcción contiene los puntos especificados se retorna null.
	 * 
	 */
	...
	/**
	 * Indica si la construcción especificada de acuerdo a sus coordenadas se
	 * sobrepone a otra construcción existente.
	 * 
	...
	public boolean sobreponeConstruccion( IConstruccion c )
	{
		...
		{
			IConstruccion aux = (IConstruccion) iter.next( );
			estaAdentroConstrucion = c.estaDentro( aux.darX( ), aux.darY( ) )
					|| c.estaDentro( aux.darX( ) + aux.darAncho( ) - DIFERENCIA,
							aux.darY( ) + aux.darAlto( ) - DIFERENCIA )
					|| c.estaDentro( aux.darX( ) + aux.darAncho( ) - DIFERENCIA, aux.darY( ) )
					|| c.estaDentro( aux.darX( ), aux.darY( ) + aux.darAlto( ) - DIFERENCIA );

			tocaConstrucionActual = aux.estaDentro( c.darX( ), c.darY( ) )
					|| aux.estaDentro( c.darX( ) + c.darAncho( ) - DIFERENCIA, c.darY( ) )
					|| aux.estaDentro( c.darX( ), c.darY( ) + c.darAlto( ) - DIFERENCIA )
					|| aux.estaDentro( c.darX( ) + c.darAncho( ) - DIFERENCIA, c.darY( ) + c.darAlto( ) - DIFERENCIA );
