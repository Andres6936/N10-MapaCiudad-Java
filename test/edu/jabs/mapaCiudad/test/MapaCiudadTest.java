package edu.jabs.mapaCiudad.test;
...
import edu.jabs.mapaCiudad.mundo.Carretera;
import edu.jabs.mapaCiudad.mundo.Casa;
import edu.jabs.mapaCiudad.mundo.Construccion;
import edu.jabs.mapaCiudad.mundo.Edificacion;
...
/**
 * Esta es la clase usada para verificar que los métodos de la clase MapaCiudad
...
public class MapaCiudadTest extends TestCase
{
	 ...
	 * <li>Al reiniciar el mapa debe quedar en blanco por ende se debe devolver null
	 * en caso de buscar una construcción.</li>
	 ...
	 * Resultados esperados:<br>
	 * <li>La esquina se agrega y se busca, por ende debe estar y no devolver
	 * null.</li>
	 */
	 ...
	 * Resultados esperados:<br>
	 * <li>La calle se agrega y se busca, por ende debe estar y no devolver
	 * null.</li>
	 */
	 ...
	 * Resultados esperados:<br>
	 * <li>La carrera se agrega y se busca, por ende debe estar y no devolver
	 * null.</li>
	 */
	 ...
	 * Resultados esperados:<br>
	 * <li>El cruce se agrega y se busca, por ende debe estar y no devolver
	 * null.</li>
	 */
	 ...
	 * Resultados esperados:<br>
	 * <li>La casa se agrega y se busca, por ende debe estar y no devolver
	 * null.</li>
	 */
	 ...
	 * Resultados esperados:<br>
	 * <li>El edificio se agrega y se busca, por ende debe estar y no devolver
	 * null.</li>
	 */
	 ...
	 * Resultados esperados:<br>
	 * <li>El hospital se agrega y se busca, por ende debe estar y no devolver
	 * null.</li>
	 */
	 ...
	 * Resultados esperados:<br>
	 * <li>La estación de bomberos se agrega y se busca, por ende debe estar y no
	 * devolver null.</li>
	 */
	 ...
	 * Verifica que una estación se agregue correctamente.<br>
	 * Resultados esperados:<br>
	 * <li>La estación de policía se agrega y se busca, por ende debe estar y no
	 * devolver null.</li>
	 */
	 ...
	 * Resultados esperados:<br>
	 * <li>La carretera debe existir, por ende la búsqueda debe ser diferente de
	 * null.</li>
	 * <li>La edificación debe existir, por ende la búsqueda debe ser diferente de
	 * null.</li>
	 * <li>La construcción debe existir, por ende la búsqueda debe ser diferente de
	 * null.</li>
	 */
	 ...
	 * <li>La carretera debe existir, por ende la búsqueda debe ser diferente de
	 * null.</li>
	 * <li>Después de la eliminación la carretera no debe existir, por ende la
	 * búsqueda debe ser null.</li>
	 */
	 ...
	 * <li>La edificación debe existir, por ende la búsqueda debe ser diferente de
	 * null.</li>
	 * <li>Después de la eliminación la edificación no debe existir, por ende la
	 * búsqueda debe ser null.</li>
	 */
	 ...
	 * <li>La construcción debe existir, por ende la búsqueda debe ser diferente de
	 * null.</li>
	 * <li>Al abrir el archivo no se debe encontrar ninguna carretera dado que se
	 * eliminó previamente.</li>
	 */
	 ...
	 * Resultados esperados:<br>
	 * <li>La construcción no debe existir dado que no estaba en el archivo, por
	 * ende la búsqueda debe retornar null.</li>
	 * <li>Dado que se guardo con la nueva construcción, al cargarla debe existir la
	 * construcción.</li>
	 */
